...
def procesar_frames(frames, carnet_frente_path, video_path=None, audio_check=True):
    ...
    if carnet_img is None:
        ...
        resultado["mensajes"].append("Falla: No se pudo leer la imagen del carnet")
        return resultado
    ...
    if carnet_crop is not None and face_frames:
        ...
        if similitudes:
            ...
            resultado["mensajes"].append(f"Similitud promedio calculada: {resultado['similitud_promedio']:.2f}%")
        else:
